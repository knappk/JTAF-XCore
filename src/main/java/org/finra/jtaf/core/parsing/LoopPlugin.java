...
public class LoopPlugin implements IPostParseTestPlugin
{
    ...
    private static int getIterationCount(Node rootNodeTest)
    {
        int result = 1;
    ...
    private static TestScript getOldTestScript(TestSuite testSuite)
    {
    ...
    private static void removeOldTestScript(TestSuite testSuite)
    {
        List<TestComponent> testComponents = testSuite.getComponentList();
