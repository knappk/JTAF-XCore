...
public class TestDependenciesPlugin implements IPostParseTestPlugin
{
    ...
    private static void handleDependencyNode(Node testChildNode, Set<String> exclusionSuites, Set<String> exclusionTests)
    {
    ...
    private static Set<String> determineSet(String nodeName, Set<String> exclusionSuites, Set<String> exclusionTests)
    {
