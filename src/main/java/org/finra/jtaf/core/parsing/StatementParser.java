...
public class StatementParser
{
    ...
    private final static void preprocessStatementList(Element elem, MessageCollector mc)
        throws ParsingException
    {
    ...
    private static boolean isNonBlockParameterType(String nodeName)
    {
    ...
    private static boolean isStringParameterType(String parameterType)
    {
